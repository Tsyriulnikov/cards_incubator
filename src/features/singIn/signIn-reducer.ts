...
export const getAuthUserData = (email: string, password: string, rememberMe: boolean) => (dispatch: AppDispatch) => {
...
export const getProfileUserdataTC = () => (dispatch: AppDispatch) => {
    authAPI.getAuth()
        .then(response => {
...
export const isAuthUserData = () => (dispatch: AppDispatch) => {
    authAPI.getAuth()
        .then(response => {
                dispatch(setAuthUserDataAC(response.data))
                dispatch(setUserID(response.data._id))
...
export const updateProfileDataTC = (name: string, avatar: string) => (dispatch: AppDispatch) => {
    dispatch(isFetchingAC(true))
